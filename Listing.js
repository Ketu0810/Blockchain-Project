...
export default function Listing() {
  ...
  const listProduct = async () => {
    ...
    const warrantyDescription =
      "Renting Period : " + warrantyPeriod + " Months";
    ...
    console.log("Sub URI : ", warrantyURI);
    setTen(true);
    ...
    //   console.log(netRent)
    //   console.log("Tasa")
    //   let tx = await netRent.methods.listItem(
    //     productURI,
    //     nftURI,
    //     productQuantity,
    //     5,
            ...
            <div className="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4">
              <div className="pt-32 sm:pt-0">
                <h2 className="font-semibold text-4xl text-blueGray-600">
                  Showcase your products on NetRent
                </h2>
                  ...
                  <div className="flex flex-wrap items-center mt-32">
                    <div className="w-full md:w-5/12 px-4 mr-auto ml-auto">
                      ...
                      <h3 className="text-3xl mb-2 font-semibold leading-normal">
                        How to list your product on NetRent
                      </h3>
                      <p className="text-lg font-light leading-relaxed mt-4 mb-4 text-blueGray-600">
                        To showcase your products on NetRent, you need to list
                      ...
                      <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-blueGray-700">
                        ...
                        <blockquote className="relative p-8 mb-4">
                          ...
                          <h4 className="text-xl font-bold text-white">
                            The future of Renting Subscriptions
                          </h4>
                      ...
                      <div className="flex-auto p-5 lg:p-10">
                        ...
                        <div className="relative w-full mb-3 mt-8">
                          <label
                            ...
                            htmlFor="full-name"
                          >
                            RENTING PERIOD IN MONTHS
                          </label>
                          <input
                            type="number"
                            className="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                            placeholder="Product Renting in Months"
                            onChange={(e) => {
                  ...
                  <div>
                    <div>
                      ...
                      >
                        ...
                        />
                        <Step
                          title="Renting Period in Months"
                          description="Enter product renting period in months"
                        />
                        <Step
                          title="Subscriptions Card"
                          description="Upload product Subscriptions Card"
                        />
                        <Step
                        ...
                        />
                        <Step
                          title="Generating Subscriptions Card URI"
                          description={
                            ten ? (
                              <a href={warrantyURI} clickable target="_blank">
                                Subscriptions Card URI
                              </a>
                            ) : (
                              "Generating ..."
                            )
              ...
              <div className="container mx-auto px-4 lg:pt-24 lg:pb-64">
                <div className="flex flex-wrap text-center justify-center">
                  <div className="w-full lg:w-6/12 px-4">
                    <h2 className="text-4xl font-semibold text-white">
                      Rent your products the GenZ way
                    </h2>
                  </div>
                </div>
                <div className="flex flex-wrap mt-12 justify-center">
                  ...
                  <div className="w-full lg:w-3/12 px-4 text-center">
                    ...
                    <h5 className="text-xl mt-5 font-semibold text-white">
                      Generate NFT backed Subscriptions Cards
                    </h5>
                  </div>
                </div>
              </div>
