...
export default function Product() {
  ...
  const getProducts = async () => {
    ...
    console.log('here');
    let productCount = await netRent.methods.itemID().call();
    ...
    for (var i = 101; i <= productCount; i++) {
      const product = await netRent.methods.items(i).call();
      console.log(product);
                ...
                {connected ? (
                  <>
                    <p className='mt-4 text-lg leading-relaxed text-blueGray-500'>
                      Welcome !! Rent your favourite products now.
                    </p>
              ...
              <div className='justify-center text-center flex flex-wrap mt-24'>
                <div className='w-full md:w-6/12 px-12 md:px-4'>
                  ...
                  <h2 className='font-semibold text-4xl'>
                    Grab your favourite Subscriptions
                  </h2>
                </div>
              </div>
            </section>
